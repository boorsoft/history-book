    ...
    return Scaffold(
      appBar: AppBar(
        ...
        Container(
          ...
          Column(
            children: [
              Text('§12.Социально-экономическое строительство в период становления советской социалистической системы (1917-1940 гг.)', style: paragraphBoldTextStyle, textAlign: TextAlign.center),
              Html(data: """
...
<p>Проводимые в начале 20-х гг. земельно-водные реформы  ставили своей целью исправить существующие с царских  времён  неравенство  между  кыргызскими  дехканами  и  русскими крестьянами по отношению к земле и воде.</p>
              ...
              Text("Земельно-водные реформы Кыргызстана (1921–1922, 1923–1926 гг.)", style: paragraphTextStyle, textAlign: TextAlign.center,),
              SizedBox(height: 12.0),
              Image.asset("assets/images/paragraphs/land-water-reform2.jpg"),
              Text("Земельно-водные реформы Кыргызстана (1927–1928 гг.)", style: paragraphTextStyle, textAlign: TextAlign.center,),
              Html(data: """
...
• В ходе коллективизации в сёлах и аилах Кыргызстана имели место многочисленные злоупотребления и перегибы. При вовлечении крестьян в  коллективные хозяйства полностью нарушались принципы добровольности, повсеместно нарушался принцип постепенности – от простых форм  (ТОЗы, товарищества) к окончательной коллективизации, крестьян насильно сгоняли в колхозы.
              ...
              Text("И. Сталин", style: paragraphTextStyle, textAlign: TextAlign.center,),
              SizedBox(height: 12.0),
              Text("Коллективизация сельского хозяйства в Кыргызстане", style: paragraphTextStyle, textAlign: TextAlign.center,),
              SizedBox(height: 12.0),
              Image.asset("assets/images/paragraphs/collectivization.jpg"),
              Text("Коллективизация по числу крестьянских дворов.", style: paragraphTextStyle, textAlign: TextAlign.center,),
              SizedBox(height: 12.0),
              Image.asset("assets/images/paragraphs/collectivization2.jpg"),
              Text("Коллективизация по посевной площади.", style: paragraphTextStyle, textAlign: TextAlign.center,),
              SizedBox(height: 12.0),
              Html(data: """
