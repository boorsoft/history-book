  ...
  Widget ContactBox(String _developer, String _email) {
    return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(_developer, style: TextStyle(
...
<p><b>Для чего приложение было разработано?</b></p>
<p>Приложение было разработано по заказу Марат агая.</p>
<p>И конечно же, по нашему желанию.</p>

<p><b>Есть предложения или нашли баг?</b></p>
<p>Если у вас есть предложения или вам пришлось встретиться лицом к лицу с багом, или с багами - пишите разработчикам, мы постараемся исправить.</p>
                """,
